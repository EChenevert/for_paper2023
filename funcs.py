...
def cv_results_and_plot_PATH(bay_model, bestfeatures, unscaled_predictor_matrix, predictor_matrix, target,
                        color_scheme: dict, marsh_key, path):
    """
    Same as the above "cv_results_and_plot" function except now we get tp specify file path!
    :param bay_model:
    :param bestfeatures:
    :param unscaled_predictor_matrix:
    :param predictor_matrix:
    :param target:
    :param color_scheme:
    :param marsh_key:
    :return:
