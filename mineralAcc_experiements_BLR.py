...
# df.to_csv("D:\\Etienne\\fall2022\\agu_data\\results\\mineralAcc\\minAcc_minimal_preprocessing.csv")
...
# udf.to_csv("D:\\Etienne\\fall2022\\agu_data\\results\\mineralAcc\\minAcc_dataset_noOutlierRm.csv")
...
for key in marshdic:
    ...
    results_dict = funcs.cv_results_and_plot_PATH(baymod, bestfeaturesM, phi, X, y,
                                                  ...
                                                  "D:\\Etienne\\PAPER_2023\\results_BLR\\mineralAcc\\")
...
for key in hold_marsh_weights:
    ...
    fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\mineralAcc\\" + str(key) +
                "_minAcc_scaledX_nolog_boxplot_human.eps", format='eps',
                dpi=300,
                bbox_inches='tight')
    plt.show()
...
for key in hold_unscaled_weights:
    ...
    funcs.wrap_labels(ax, 10)
    fig.subplots_adjust(bottom=0.3)
    fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\mineralAcc\\" + str(
        key) + "_minAcc_unscaledWeights_nolog_boxplot_human.eps", format='eps',
                dpi=300,
                bbox_inches='tight')
    plt.show()
...
funcs.wrap_labels(ax, 10)
fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\mineralAcc\\minAcc_regularization_scaledX_nolog_boxplot_human.eps",
            format='eps',
            dpi=300,
            bbox_inches='tight')
plt.show()
...
funcs.wrap_labels(ax, 10)
fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\mineralAcc\\minAcc_certainty_scaledX_nolog_boxplot_human.eps",
            format='eps',
            dpi=300,
            bbox_inches='tight')
plt.show()
...
funcs.wrap_labels(ax, 10)
fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\mineralAcc\\minAcc_intercepts_nolog_boxplot_human.eps", dpi=300,
            format='eps',
            bbox_inches='tight')
plt.show()
...
funcs.wrap_labels(ax, 10)
fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\mineralAcc\\minAcc_pred_certainty_scaledX_nolog_boxplot_human.eps",
            dpi=300, format='eps',
            bbox_inches='tight')
plt.show()
