...
# df.to_csv("D:\\Etienne\\fall2022\\agu_data\\results\\minAcc_minimal_preprocessing.csv")
...
# gdf.to_csv("D:\\Etienne\\fall2022\\agu_data\\results\\minAcc_dataset.csv")
...
funcs.wrap_labels(ax, 10)
# fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\minAcc_regularization_scaledX_nolog_boxplot_human.eps",
#             format='eps',
#             dpi=300,
#             bbox_inches='tight')
plt.show()
...
funcs.wrap_labels(ax, 10)
# fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\minAcc_certainty_scaledX_nolog_boxplot_human.eps",
#             format='eps',
#             dpi=300,
#             bbox_inches='tight')
plt.show()
...
funcs.wrap_labels(ax, 10)
# fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\minAcc_intercepts_nolog_boxplot_human.eps", dpi=300,
#             format='eps',
#             bbox_inches='tight')
plt.show()
...
funcs.wrap_labels(ax, 10)
# fig.savefig("D:\\Etienne\\PAPER_2023\\results_BLR\\minAcc_pred_certainty_scaledX_nolog_boxplot_human.eps",
#             dpi=300, format='eps',
#             bbox_inches='tight')
plt.show()
